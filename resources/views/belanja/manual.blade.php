<x-app-layout>
  <x-slot name="header">
    {{ __('Create Pengeluaran Bahan Produksi') }}
  </x-slot>
  ...
  <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
    ...
    <div class="grid grid-cols-1">
      <!-- Breadcrumb Start -->
      <div x-data="{ 
        pageName: `Add Pengeluaran Bahan Produksi`,
        urls:[
      ...
      >
        ...
        <div class="grid grid-cols-12 border border-gray-100 dark:border-gray-800">
          <form
            ...
            action="{{ route('belanja.store.manual') }}"
            method="POST"
          >
            @csrf
