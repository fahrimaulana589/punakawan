  ...
  <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
    ...
    <div class="grid grid-cols-1">
      <!-- Breadcrumb Start -->
      <div x-data="{ 
        pageName: `Generate Laporan Gaji`,
        urls:[
        ...
        <div class="grid grid-cols-12 border border-gray-100 dark:border-gray-800">
          ...
          >
                ...
                <div class="dark:text-white rounded-sm p-2 col-span-12 md:col-span-6 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                  ...
                  @foreach($karyawan->penggajians as $penggajian)
                    @if($penggajian->type == 'potongan_bulanan')
                      ...
                      @php $gaji = $gaji - $penggajian->total @endphp
                      @php $jenis = 'Potongan' @endphp
                    @elseif($penggajian->type == 'potongan_absensi')
                      @php $lainya = ($penggajian->total * $alpaCount) @endphp    
                      @php $gaji = $gaji - ($penggajian->total * $alpaCount) @endphp
                      @php $jenis = 'Potongan' @endphp
                    ...
                    @elseif($penggajian->type == 'tunjangan_harian')
                      @php $gaji = $gaji + ($penggajian->total * $hadirCount) @endphp
                      @php $lainya = ($penggajian->total * $hadirCount) @endphp
                      @php $jenis = 'Tunjangan' @endphp    
                    @endif
            ...
            <div class="flex items-center justify-end gap-2">
              ...
              <button
                type="button"
                @click.prevent="document.getElementById('generate').submit()"
